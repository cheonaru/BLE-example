...
import static techtown.org.MainActivity.CHARACTERISTIC_COMMAND_STRING;
import static techtown.org.MainActivity.CHARACTERISTIC_RESPONSE_STRING;
import static techtown.org.MainActivity.CLIENT_CONFIGURATION_DESCRIPTOR_SHORT_ID;
import static techtown.org.MainActivity.SERVICE_STRING;
...
public class BluetoothUtils {
    ...
    public static BluetoothGattCharacteristic findEchoCharacteristic(BluetoothGatt bluetoothGatt) {
        return findCharacteristic(bluetoothGatt, CHARACTERISTIC_COMMAND_STRING);
    }
    ...
    public static boolean isEchoCharacteristic(BluetoothGattCharacteristic characteristic) {
        return characteristicMatches(characteristic, CHARACTERISTIC_COMMAND_STRING);
    }

    public static boolean isTimeCharacteristic(BluetoothGattCharacteristic characteristic) {
        return characteristicMatches(characteristic, CHARACTERISTIC_RESPONSE_STRING);
    }
    ...
    private static boolean matchesCharacteristicUuidString(String characteristicIdString) {
        return uuidMatches(characteristicIdString, CHARACTERISTIC_COMMAND_STRING, CHARACTERISTIC_RESPONSE_STRING);
    }
